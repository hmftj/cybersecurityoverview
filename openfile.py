...
def iprec():
     ...
     prompt="server ip address or port?:")

     # check it out
     print("Recieved from ip", USER_INP)
...
def ipsen():
     ...
     # the input dialog
     USER_INP = simpledialog.askstring(title="Test",
     prompt="Reciever ip address or port?:")

     # check it out
     print("Sendind to ip", USER_INP)
...
def goback():
	exit()
btn_select_file = Button( txt_window, text = "Recieve" , command = iprec)
btn_select_file.place( x=70, y=130 )


btn_select_file = Button( txt_window, text = "Send " , command = ipsen)
btn_select_file.place( x=30, y=180 )

btn_select_file = Button( txt_window, text = "Go Back" , command = goback)
btn_select_file.place( x=160, y=100 )
