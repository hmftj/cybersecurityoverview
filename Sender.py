...
#--Key transfer it generate two files one for decryption and one for encryption----------
...
def menu():
    ...
    Button(root, text='Generate Key', command=Key_transfer, fg="blue").place(x=400, y=350)
    Button(root, text='Encrypt Decrypt text', command=File_open, fg="blue").place(x=400, y=450)
    Button(root, text='View Text', command=viewtext, fg="blue").place(x=200, y=450)
